...
Thanks to my examiner Ibrahim Orhan for giving great feedback, inspiring me to focus on the task at hand and helping me with the disposition.
...
For the system of service identification, a wrapper around \emph{Nmap} is implemented, which performs a scan of the network nodes and returns a list of available services.
...
!\highlight{1026/tcp open     upnp    XBox 360 XML UPnP (Serial number 757502283805)}!
