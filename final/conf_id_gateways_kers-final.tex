...
\businesslogo{\includegraphics[width=4cm]{Inteno.eps}}
...
\begin{figure}[h]
   \centering
   %                       left down right top
   \includegraphics[trim = 0mm 140mm 90mm 0mm, clip, width=10cm]{before.eps}
...
\begin{figure}[h]
   \centering
   %                       left down right top
   \includegraphics[trim = 0mm 174mm 80mm 0mm, clip, width=10cm]{after.eps}
...
\begin{figure}[h!]
   \centering
   \includegraphics[trim = 0mm 190mm 30mm 0mm, clip, width=15cm]{wizard-seq_dia.eps}
...
\includegraphics{ss-scanning-shadow.png}
